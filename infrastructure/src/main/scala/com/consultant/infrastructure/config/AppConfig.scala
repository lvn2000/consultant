...
object AppConfig:
  ...
  def load: IO[AppConfig] =
    val baseConfig = (
      ...
      env("DB_URL").as[String].default("jdbc:postgresql://localhost:5432/consultant_db"),
      env("DB_USER").as[String].default("consultant"),
      env("DB_PASSWORD").as[String].default("bW1g55n9"),
